...
export default function Header() {
    return(
        <div className="header">
            <img className="profile-img" src={Myphoto}/>
            <h1>Bruce Ip</h1>
            <h4>Junior Full-Stack Developer</h4>
            <span><a href="https://bruceiplol.github.io/Bruce-Personal-Portfolio/">bruceiplol.github.io/Bruce-Personal-Portfolio/</a></span>
